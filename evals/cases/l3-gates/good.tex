\chapter{Proposed Methodology}\label{cap:metodologia}

This chapter describes the methodology. It contains the representation, the propagation and the prediction head.

\section{Representation}\label{sec:met_representacao}

Protein embeddings come from the concatenation of protein language model layers.

\chapter{Experiments and Results}\label{cap:resultados}

This chapter reports the experiments defined in Chapter~\ref{cap:metodologia}. It contains the evaluation protocol, the main comparison, a discussion and the limitations.
...
Table~\ref{tab:res_main} summarises the main comparison. Early Fusion reaches an fmax of 0.5869 on the test split, while Late Fusion reaches 0.5712.
The fmax of 0.5869 is the best value observed across all configurations, a consistent margin over the baseline.
...
\section{Discussion}\label{sec:res_discussao}
