...
Ticket T1 (`docs/commercial/TICKETS.md`) is the parity check itself: run the steps above, write `docs/experiments/codex-parity-2026-09.md` with every divergence as a numbered list (command, output), and stop for the owner's yes before any fix wider than one line. Then T2, T3, T4 and T5 can proceed in any order; T6 waits for T5's owner steps.
